...
function start_game(companies) {
    ...
    // Put it in the page
    document.getElementById('price').innerText = company.price
    document.getElementById('marketcap').innerText = company.marketcap
    document.getElementById('sector').innerText = company.sector
    document.getElementById('subsector').innerText = company.subsector
    document.getElementById('hq').innerText = company.hq
    document.getElementById('founded').innerText = company.founded
    document.getElementById('added').innerText = company.added
...
function do_guess() {
    ...
    if (guess == correct_company_guess) {
        ...
        if (guess_number == number_of_guesses) {
            ...
            guess_entry.value = ""
            guess_number++
            Array.from(document.getElementsByClassName(clue_order[guess_number-1])).forEach(
                function(element) {
